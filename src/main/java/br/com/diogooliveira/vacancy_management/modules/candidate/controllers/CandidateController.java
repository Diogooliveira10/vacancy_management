...
import br.com.diogooliveira.vacancy_management.modules.candidate.userCases.ApplyJobCandidateUseCase;
...
public class CandidateController {
    ...
    @PreAuthorize("hasRole('CANDIDATE')")
    @Operation(
        summary = "Candidate application for a job position.",
        description = "This function is responsible for registering the candidate for a job position."
    )
    @SecurityRequirement(
        name = "jwt_auth"
    )
